...
public class Cuenta {
    ...
    public boolean trasferir(double cantidadTransferir, Cuenta cuenta){
        if(cantidadTransferir <= 0) throw new IllegalArgumentException("No se pueden transferir cantidades negativas");
    ...
    public void depositar(double cantidadDepositar){
        if(cantidadDepositar <= 0) throw new IllegalArgumentException("No se pueden retirar cantidades negativas");
        saldo = saldo + cantidadDepositar;
    }

    public boolean retirar(double cantidadRetirar){
        if (cantidadRetirar  <= 0) throw new IllegalArgumentException("No se pueden retirar cantiades negativas");
